...
REM rename folder
REM if %OS%==32BIT ren exe.win32-3.4 SESEuPy_Windows_Executable_x86
REM if %OS%==64BIT ren exe.win-amd64-3.4 SESEuPy_Windows_Executable_x86_64
REM copy the Examples folder, for xcopy \ at the end defaults to a folder, * at the end to a file
REM if %OS%==32BIT xcopy ..\Examples SESEuPy_Windows_Executable_x86\Examples\ /s /e /h
REM if %OS%==64BIT xcopy ..\Examples SESEuPy_Windows_Executable_x86_64\Examples\ /s /e /h
REM move folder 2 directories up
REM if %OS%==32BIT move SESEuPy_Windows_Executable_x86 ..\..
REM if %OS%==64BIT move SESEuPy_Windows_Executable_x86_64 ..\..
...
REM rename folder
if %OS%==x86 ren exe.win32-3.4 SESEuPy_Windows_Executable_%OS%_%datetimef%
if %OS%==x86_64 ren exe.win-amd64-3.4 SESEuPy_Windows_Executable_%OS%_%datetimef%
REM move folder 2 directories up
move SESEuPy_Windows_Executable_%OS%_%datetimef% ..\..
